...
#define mkV(x) f1(x, v)
#define mk2I(x) f2(x, i, i)
#define mkIUI(x) f2(x, i, ui)
#define mk2L(x) f2(x, l, l)
#define mkIL(x) f2(x, i, l)
#define mkIUL(x) f2(x, i, ul)
#define mkILL(x) f2(x, i, ll)
#define mkIULL(x) f2(x, i, ull)
#define mk2D(x) f2(x, d, d)
#define mk3D(x) f3(x, d, d, d)
#define mkI2D(x) f3(x, i, d, d)
