...
#define mkPrefetch(name, rw, locality) v prefetch ## name(cvp addr) { b(prefetch)(addr, rw, locality); }

mkPrefetch(ReadHighLocality, 0, 3)
mkPrefetch(ReadMediumLocality, 0, 2)
mkPrefetch(ReadLowLocality, 0, 1)
mkPrefetch(ReadNoLocality, 0, 0)
mkPrefetch(WriteHighLocality, 1, 3)
mkPrefetch(WriteMediumLocality, 1, 2)
mkPrefetch(WriteLowLocality, 1, 1)
mkPrefetch(WriteNoLocality, 1, 0)
